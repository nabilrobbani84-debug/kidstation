...
<div class="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 mb-8">
    <div class="bg-white p-4 sm:p-6 rounded-2xl shadow-sm border-l-4 border-green-500">
        ...
        <h3 class="text-xl sm:text-2xl font-bold text-green-600 break-words">Rp {{ number_format($totalSales, 0, ',', '.') }}</h3>
    </div>
    <div class="bg-white p-4 sm:p-6 rounded-2xl shadow-sm border-l-4 border-red-500">
        ...
        <h3 class="text-xl sm:text-2xl font-bold text-red-600 break-words">Rp {{ number_format($totalExpenses, 0, ',', '.') }}</h3>
    </div>
</div>
